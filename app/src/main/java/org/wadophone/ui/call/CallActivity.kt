...
import org.wadophone.compatibility.Api28Compatibility
import org.wadophone.compatibility.Compatibility
import org.linphone.core.tools.Log
import org.wadophone.databinding.CallActivityBinding
import org.wadophone.notifications.NotificationsManager
import org.wadophone.ui.GenericActivity
import org.wadophone.ui.call.conference.fragment.ActiveConferenceCallFragmentDirections
import org.wadophone.ui.call.conference.fragment.ConferenceLayoutMenuDialogFragment
import org.wadophone.ui.call.fragment.ActiveCallFragmentDirections
import org.wadophone.ui.call.fragment.AudioDevicesMenuDialogFragment
import org.wadophone.ui.call.fragment.CallsListFragmentDirections
import org.wadophone.ui.call.fragment.IncomingCallFragmentDirections
import org.wadophone.ui.call.fragment.OutgoingCallFragmentDirections
import org.wadophone.ui.call.model.AudioDeviceModel
import org.wadophone.ui.call.viewmodel.CallsViewModel
import org.wadophone.ui.call.viewmodel.CurrentCallViewModel
import org.wadophone.ui.call.viewmodel.SharedCallViewModel
...
class CallActivity : GenericActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        answerCallIfRequestedByIntent(intent)
    ...
    private fun answerCallIfRequestedByIntent(intent: Intent) {
        if (intent.extras?.getBoolean(NotificationsManager.INTENT_ANSWER_CALL_EXTRA, false) != true) {
            return
        }
        // Consume the extra so a configuration change / onNewIntent replay doesn't answer twice
        intent.removeExtra(NotificationsManager.INTENT_ANSWER_CALL_EXTRA)

        val remoteSipUri = intent.getStringExtra(NotificationsManager.INTENT_REMOTE_SIP_URI)
        Log.i(
            "$TAG Answer call was requested from the notification action, answering now for [$remoteSipUri]"
        )
        coreContext.postOnCoreThread { core ->
            ...
            if (call != null) {
                ...
                Log.e("$TAG Couldn't find any call to answer")
            }
        }
    }

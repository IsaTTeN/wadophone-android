 ...
 */
package org.wadophone.ui.main.help.viewmodel
...
class HelpViewModel
    ...
    init {
        ...
        coreContext.postOnCoreThread { core ->
            ...
            // No Wadophone update-check server exists yet: Linphone's own server would only
            // ever report Linphone releases, with a link to Linphone's Play Store page.
            checkUpdateAvailable.postValue(false)

...
import org.wadophone.databinding.MainActivityBinding
import org.wadophone.ui.GenericActivity
import org.wadophone.ui.assistant.AssistantActivity
import org.wadophone.ui.main.chat.fragment.ConversationsListFragmentDirections
import org.wadophone.utils.PasswordDialogModel
import org.wadophone.ui.main.viewmodel.MainViewModel
import org.wadophone.ui.main.viewmodel.SharedMainViewModel
import org.wadophone.ui.welcome.WelcomeActivity
...
import org.wadophone.ui.sso.SingleSignOnActivity
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        coreContext.postOnCoreThread {
            if (corePreferences.firstLaunch) {
                Log.i("$TAG First time Wadophone has been started, showing Welcome activity")
            ...
            // No account configured is a valid state here: the user only reaches the
            // account setup screen by explicitly tapping "Add account" in the drawer
            // menu, never through a forced redirect.
        }
    }

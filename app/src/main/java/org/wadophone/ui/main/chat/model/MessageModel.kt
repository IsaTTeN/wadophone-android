 ...
 */
package org.wadophone.ui.main.chat.model
...
import org.wadophone.utils.PatternClickableSpan
import org.wadophone.utils.SpannableClickedListener
    ...
    private fun computeTextContent(content: Content, highlight: String) {
        ...
        while (matcher.find()) {
            ...
            if (address != null) {
                ...
                // Change color
                spannableBuilder.setSpan(
                    ForegroundColorSpan(AppUtils.getColorInt(R.color.red_main_500)),
                    start + offset,
                    start + offset + displayName.length + 1,
                    Spanned.SPAN_EXCLUSIVE_EXCLUSIVE
                )

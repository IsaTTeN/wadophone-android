 ...
 */
package org.wadophone.ui.welcome
...
import org.wadophone.databinding.WelcomeActivityBinding
import org.wadophone.ui.GenericActivity
import org.wadophone.ui.assistant.AssistantActivity
import org.wadophone.ui.welcome.fragment.WelcomePage1Fragment
import org.wadophone.ui.welcome.fragment.WelcomePage2Fragment
import org.wadophone.ui.welcome.fragment.WelcomePage3Fragment
...
class WelcomeActivity : GenericActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.setSkipClickListener {
            Log.i("$TAG User clicked on 'skip' button, requesting permissions")
            requestPermissionsThenLeave()
        }

        binding.setNextClickListener {
            if (viewPager.currentItem == PAGES - 1) {
                Log.i(
                    "$TAG User clicked on 'start' button, requesting permissions"
                )
                requestPermissionsThenLeave()
            } else {
    ...
    private fun requestPermissionsThenLeave() {
        finish()
        val intent = Intent(this, AssistantActivity::class.java)
        intent.putExtra(AssistantActivity.PERMISSIONS_ONLY_EXTRA, true)

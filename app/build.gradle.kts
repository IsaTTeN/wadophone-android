...
val packageName = "org.wadophone"
val useDifferentPackageNameForDebugBuild = true
...
android {
    ...
    applicationVariants.all {
        ...
        variant.outputs
            ...
            .forEach { output ->
                output.outputFileName = "wadophone-android-${variant.buildType.name}-$gitVersion.apk"
            }
    }
